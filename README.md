<a name="readme-top"></a>
<h1 align="center">FitU</h1> 

<h3 align="center">Your Personal AI Fitness Companion</h3>

<p align="center">
  <img width="200" height="160" src="path_to_fitu_logo.png" alt="FitU Logo">
</p>

## Mobile project with AI

Welcome to FitU, an innovative Android application developed with Kotlin that leverages MediaPipe Pose Landmark Detection. FitU accurately counts repetitions and guides you through your fitness journey with the PathFit curriculum.
...
Developed as part of our third-year course at Metropolia University of Applied Sciences, FitU is a collaborative effort by a team of four students. Our primary objective was to create an innovative fitness application adhering to specific guidelines and meeting the course requirements.


## Features

- **Pose Detection AI Model:** Accurate detection of user poses to evaluate exercise form.
- **PathFit Curriculum:** Structured fitness programs aligned with educational goals.
- **Gamification:** Achievement system and progress tracking to keep users motivated.
- **Pose Classification:** Identify and classify different exercise poses for precise feedback.
- **Repetition Counting:** The AI model accurately counts repetitions for each exercise.
- **Real-Time Feedback:** Uses MediaPipe Pose Landmark Detection for real-time form analysis.
- **Exercise Plan:** Create customized exercise plans within the PathFit framework.
- **Room Database:** Utilizes Room database for storing exercise plans and results.
- **Voice Notifications:** Receive voice guidance during workouts.
- **Exercise History:** Detailed progress tracking and performance analytics.
- **Camera Flipping:** Switch between front and back cameras for optimal viewing.
...
1. Clone the repository
    ```http
     https://github.com/YourUsername/FitU.git
    ```
...
OR--
1. Download the  [app-release.apk](https://github.com/YourUsername/FitU/releases/tag/ReleaseV1.0.0) to Android phone
